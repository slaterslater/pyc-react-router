...
export default function IntroOffer() {
  ...
  return (
    <div className="flex flex-col gap-8 p-4 items-center">
      ...
      <p className="subtitle">Get started with our Intro Special available at every studio.<br /> Find the flexible class passes or membership to power your practice</p>
